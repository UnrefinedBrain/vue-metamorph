...
export interface Visitor<M = {}> {
  ...
  visitTSEnumBody?(this: Context & M, path: NodePath<namedTypes.TSEnumBody>): any;
  visitTSInterfaceHeritage?(this: Context & M, path: NodePath<namedTypes.TSInterfaceHeritage>): any;
  visitTSClassImplements?(this: Context & M, path: NodePath<namedTypes.TSClassImplements>): any;
  visitTSTemplateLiteralType?(this: Context & M, path: NodePath<namedTypes.TSTemplateLiteralType>): any;
  visitTSEmptyBodyFunctionExpression?(
    this: Context & M,
    path: NodePath<namedTypes.TSEmptyBodyFunctionExpression>
  ): any;
  visitTSAbstractMethodDefinition?(this: Context & M, path: NodePath<namedTypes.TSAbstractMethodDefinition>): any;
  visitTSAbstractPropertyDefinition?(this: Context & M, path: NodePath<namedTypes.TSAbstractPropertyDefinition>): any;
}