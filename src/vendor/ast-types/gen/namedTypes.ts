...
export namespace namedTypes {
  ...
  export interface JSXText extends Omit<Literal, "type" | "value" | "raw"> {
    type: "JSXText";
    value: string;
    raw?: string;
  }
  ...
  export interface NumericLiteral extends Omit<Literal, "type" | "value" | "raw"> {
    type: "NumericLiteral";
    value: number;
    raw?: string | null;
    extra?: {
  ...
  export interface RegExpLiteral extends Omit<Literal, "type" | "value" | "regex"> {
    type: "RegExpLiteral";
    pattern: string;
    flags: string;
    value?: RegExp;
  ...
  export interface TSEnumBody extends Omit<Node, "type"> {
    type: "TSEnumBody";
    members: K.TSEnumMemberKind[];
  }

  export interface TSInterfaceHeritage extends Omit<Node, "type"> {
    type: "TSInterfaceHeritage";
    expression: K.IdentifierKind | K.TSQualifiedNameKind;
    typeArguments?: K.TSTypeParameterInstantiationKind | null | undefined;
  }

  export interface TSClassImplements extends Omit<Node, "type"> {
    type: "TSClassImplements";
    expression: K.IdentifierKind | K.TSQualifiedNameKind;
    typeArguments?: K.TSTypeParameterInstantiationKind | null | undefined;
  }

  export interface TSTemplateLiteralType extends Omit<TSType, "type"> {
    type: "TSTemplateLiteralType";
    quasis: K.TemplateElementKind[];
    types: K.TSTypeKind[];
  }

  export interface TSEmptyBodyFunctionExpression extends Omit<FunctionExpression, "type" | "id" | "params" | "body" | "declare" | "expression" | "returnType"> {
  ...
  export interface TSAbstractMethodDefinition extends Omit<MethodDefinition, "type" | "value" | "accessibility" | "decorators" | "optional" | "override"> {
  ...
  export interface TSAbstractPropertyDefinition extends Omit<PropertyDefinition, "type" | "value" | "accessibility" | "declare" | "definite" | "optional" | "override" | "readonly"> {
  ...
  export let TSEnumBody: Type<TSEnumBody>;
  export let TSInterfaceHeritage: Type<TSInterfaceHeritage>;
  export let TSClassImplements: Type<TSClassImplements>;
  export let TSTemplateLiteralType: Type<TSTemplateLiteralType>;
  export let TSEmptyBodyFunctionExpression: Type<TSEmptyBodyFunctionExpression>;
  export let TSAbstractMethodDefinition: Type<TSAbstractMethodDefinition>;
  export let TSAbstractPropertyDefinition: Type<TSAbstractPropertyDefinition>;
}
...
export interface NamedTypes {
  ...
  TSEnumBody: Type<namedTypes.TSEnumBody>;
  TSInterfaceHeritage: Type<namedTypes.TSInterfaceHeritage>;
  TSClassImplements: Type<namedTypes.TSClassImplements>;
  TSTemplateLiteralType: Type<namedTypes.TSTemplateLiteralType>;
  TSEmptyBodyFunctionExpression: Type<namedTypes.TSEmptyBodyFunctionExpression>;
  TSAbstractMethodDefinition: Type<namedTypes.TSAbstractMethodDefinition>;
  TSAbstractPropertyDefinition: Type<namedTypes.TSAbstractPropertyDefinition>;
}